...
Der ADC hat eine Auflösung von 12bit, somit hat das Verfahren auch 12 Schritte.
...
\end{align}
Für die Sensoren werden verschiedene Schaltungen verwendet, die im Follgenden näher erläutert.
...
Aus diesem Grund wird die am PT1000 abfallende Spannung noch verstärkt werden muss.
...
Zur aschließenden Berechnung der Temperatur aus den gemessenen Widerständen wird die Formel %ref auf Formel
verwendet.
