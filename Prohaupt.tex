...
\begin{figure}[!h]
\centering
\includegraphics[width=0.5\textwidth]{PT1000Schaltung.png}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.5\textwidth]{PhotodiodeSchaltung.png}
\caption{Beschaltung der Photodiode mit Widerstand und Verstärkerachaltung.}
\label{fig:PhotodiodeSchaltung}
\end{figure}
\begin{figure}[!h]
\centering
\includegraphics[width=0.6\textwidth]{LEDSchaltung.png}
