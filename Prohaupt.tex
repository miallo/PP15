...
\begin{figure}[!htb]
	...
	\caption{Alle gemessenen Intensitätwerte aus Göttingen logarithmisch aufgetragen. Desweiteren ist die Grenzgerade, welche die mittlere Intesitätsanbnahme darstellt.}
	\label{fig:lichtGoe}
\end{figure}
...
\begin{figure}[!htb]
	...
	\caption{Intensität der einzelnen LEDs (Infrarot und Blau) in Differenz zur Sonnenintensität.}
	\label{fig:led}
\end{figure}
