...
Die Gerade hat die Form $T(z)=(21.185\pm)\si{\celsius}-(0.430\pm)\si{\celsius\per\meter}\cdot z$.
...
Vergleicht man jeweils die beiden Temperaturkurven in Abb. \ref{fig:tempV1} und \ref{fig:tempV3}, erkennt man keine großen Temperaturdifferenzen.
...
\begin{figure}[!htb]
	...
	\caption{Unterschied Sonnenlicht+LED zu Sonnenlicht (logarithmisch)}
	\label{fig:led}]
\end{figure}
