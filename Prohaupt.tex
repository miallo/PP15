...
\begin{align}
 \left<\omega\right> = \frac{1}{2} \rho \omega^2 A^2~.
\end{align}
...
Das Senderkristall wird mithilfe von PWM (Puls Width Modulation) mit einem Signal von maximal +3.3\si{\volt} versorgt, um diese Maximalspannung zu erhöhen wird das Kristall über ein MOSFET-Transistor an +24\si{\volt} betrieben.%Schaltung hinzufeugen
...
<<<<<<< HEAD
In Abb. \ref{fig:GPSNort} kann man erkennen, dass wir in NorthPA293eim mit der Unterstützung der Smartphone-App wesentlich besser gefahren sind.
...
>>>>>>> 9a6ccb2716f558fb3ce98d82c8438e8adf6c7844
...
Darüberhinaus waren noch einige Werte bei bis zu $140\,\si{\celsius}$, welche jedoch augenscheinlich durch einen Wackelkontakt in der Stromversorgung zustande kamen.
...
Dabei werden immer von 40 Werten nach dem folgenden Algorithmus zu einem Temperaturwert zusammengefasst: 
...
\begin{figure}[!h]
   ...
   {\resizebox{.49\linewidth}{!}{\input{Northeim/tempAlg2.tex}}}
	\caption{Algorithmus zum Filtern der Temperaturdaten.}
	\label{fig:tempAlg}
\end{figure}
...
Allerdings ist ein sehr kleines Loch in der Kammer, damit ein Druckausgleich stattfinden kann.
...
Daraufhin bekamen wir einen Sensor der 
Die Druckmessung wird über die externe Schaltung betrieben und wurde deshalb nicht von den Spannungsschwankungen des Boards direkt beeinflusst.
...
Laut Datenblatt liegt der Unterschied in der Effizienz zwischen den beiden Wellenlängen bei 40\%, was sich auch in der Auswertung bemerkbar machte. %refferez auf Datenblatt
