...
<<<<<<< HEAD
Weil diese Zustände aber nun beliebig kompliziert werden können, muss man auf makroskopischer Ebene spektroskopische Versuche durchführen, um die Absorptionsspektren zu untersuchen.
=======
...
>>>>>>> a4e582e7e3c4a4d3c8da999b0126401006a0087a
...
\begin{figure}[!h]
	\centering
	\subfigure[Temperatur gegen Tiefe. \label{fig:tempGoeBsp1}]
   {\resizebox{0.49\linewidth}{!}{\input{GoeKiessee/temp_goe_bsp.tex}}}
   \hfill
   \subfigure[Temperatur gegen Zeit.\label{fig:tempGoeBsp2}]
...
\begin{figure}[!htb]
   ...
   {\resizebox{.49\linewidth}{!}{\input{Northeim/tempV3.tex}}}
	\caption{Messpunkte (in a), die wir zweimal besucht haben, und deren Temperaturkurven.}
	\label{fig:tempNort2}
\end{figure}
...
Die Intenität $I$ ist in unserem Fall proportional zur Photospannung $U_\text{Photo}$.
...
\begin{figure}[!htb]
	...
	\caption{Göttingen Lichtabsorbtion: alle Messdaten (logarithmisch).}
	\label{fig:lichtGoe}
\end{figure}
...
\begin{figure}[!h]
   ...
   \hfill
   \subfigure[Einzelne Verläufe: Gute Korrelation.\label{fig:l1}]
   {\resizebox{.49\linewidth}{!}{\input{Northeim/l1.tex}}}
   \hfill
   \subfigure[Einzelne Verläufe: Schlechte Korrelation.\label{fig:l2}]
   {\resizebox{.49\linewidth}{!}{\input{Northeim/l2.tex}}}
   \hfill
	\caption{Northeim: Lichtabsorption.}
	\label{fig:lichtNort}
\end{figure}
In Abbildung \ref{fig:lichtabs} sind wieder alle aufgennomenen Messwerte der Intensität gegen die Tiefe aufgetragen.
$a=0.40\pm0.02$.
Ebenfalls ist wieder eine linearer Regression durchgeführt worden, die den Mittelwert der Absorbtion zeigt, da der See wieder als homogen angenommen wird.\\%Ergebnisse
...
\begin{figure}[!htb]
	...
	\caption{Unterschied Sonnenlicht+LED zu Sonnenlicht}
	\label{fig:led}
\end{figure}
...
Desweiteren ist die, wie oben beschriebene Streuungen auf den ersten Metern gut zu erkennen.
...
Die Infrarote LED hat somit eine höhere Intensität von.
...
Nun ist es nötig entweder die 3.3\si{\volt} des Boards zu nehmen und das rippling zu vermindern, oder eine eigene lastfreie Spannungsquelle zu bauen.
Zu dem muss ein Tiefpassfilter mithilfe einer Drosselspule in Reihe geschaltet werden um das durch die Elektronik induzierte hochfrequente Rauschen zu unterdrücken.
>>>>>>> a4e582e7e3c4a4d3c8da999b0126401006a0087a
