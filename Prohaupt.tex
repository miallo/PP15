...
%ADCbeschreiben
Zur Bestimmung der am Kontroller anliegenden Spannung wird ein integrierter ADC verwendet.
...
Dies ist notwendig, da der Lichtsensor an der Oberfläche eine zu hohe Spannung liefert und so den ADC übersteuert.
...
Er besitzt eine Schaltung, welche das Signal direkt so verstärkt, dass bei einem Druck von  wird direkt an eine Batterie angeschlossen
