...
do for [i=0:int(STATS_blocks-1)] {	
	...
	stats 'superTemp3.dat' index i u 0:5 name "maxTiefe" nooutput
	TiefeMax = maxTiefe_max_y
	...
	do for [j=-1:(floor(TiefeMax/binsize))]{
		...
		print lat_mean_y, long_mean_y, TiefeMax, tiefe, temp2_mean_y, temp2_stddev_y, temp_records, temp2_records
